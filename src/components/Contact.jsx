        ...
        <div className="flex lg:w-4/5 sm:mb-2 -mx-40">
          ...
          >
            ...
            <p className="leading relaxed mb-5" >
              I will revert back within a business day!
            </p>
            ...
            <div className="relative mb-4" style={{ width: "100%" }}>
              ...
              <textarea
                ...
                className="w-full h-3/5 bg-gray-800 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 h-32 text-base outline-none text-gray-100 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
              />
            </div>
            <button
              type="submit"
